...
class ENHSPsolver(PDDLSolver):
    ...
    def _result_status(self, problem: 'up.model.Problem', plan: Optional['up.plan.Plan']) -> int:
        ...
        return up.solvers.results.UNSOLVABLE_PROVEN if plan is None else up.solvers.results.SOLVED_SATISFICING
    ...
    def solve(self, problem: 'up.model.Problem',
                ...
                result = super().solve(problem,callback,timeout,output_stream)
                result.planner_name = 'Enhsp'
                return result
    @staticmethod
