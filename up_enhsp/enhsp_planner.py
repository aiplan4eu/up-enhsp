...
class ENHSPsolver(Solver):
    ...
    def _get_cmd(self, domain_filename: str, problem_filename: str, plan_filename: str) -> List[str]:
        base_command = [pkg_resources.resource_filename(__name__, 'openjdk/bin/java'), '-jar', pkg_resources.resource_filename(__name__, 'ENHSP/enhsp-dist/enhsp.jar'), '-o', domain_filename, '-f', problem_filename, '-sp', plan_filename]
